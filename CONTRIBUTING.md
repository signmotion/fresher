...
- Clone the forked repository to your local development machine
  (e.g. `git clone git@github.com:<YOUR_GITHUB_USER>/fresher.git`).
...
Go to the [pull request page of Fresher][PRs] and in the top
...
[GitHub issue]: https://github.com/signmotion/fresher/issues/new
[GitHub issues]: https://github.com/signmotion/fresher/issues
[PRs]: https://github.com/signmotion/fresher/pulls
